import pytest
import python_project_subnet_calculator
...
def test_is_valid_ip_address(numberlist):
    student = python_project_subnet_calculator.is_valid_ip_address(numberlist)
...
def test_is_valid_netmask(numberlist):
    student = python_project_subnet_calculator.is_valid_netmask(numberlist)
...
def test_one_bits_in_netmask(numberlist):
    student = python_project_subnet_calculator.one_bits_in_netmask(numberlist)
...
def test_apply_network_mask(host_address,netmask):
    student = python_project_subnet_calculator.apply_network_mask(host_address,netmask)
...
def test_netmask_to_wildcard_mask(numberlist):
    student = python_project_subnet_calculator.netmask_to_wildcard_mask(numberlist)
...
def test_apply_network_mask(host_address,wildcard_mask):
    student = python_project_subnet_calculator.get_broadcast_address(host_address,wildcard_mask)
...
def test_prefix_length_to_max_hosts(prefix_length):
    student = python_project_subnet_calculator.prefix_length_to_max_hosts(prefix_length)
